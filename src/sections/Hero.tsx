  ...
  return (
    ...
    >
      ...
      transition = {{
        ...
        className="absolute h-[344px] w-[344px] md:h-[550px] md:w-[550px] border border-white opacity-20 rounded-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">
      ...
      className="absolute h-[444px] w-[444px] md:h-[750px] md:w-[750px] border border-white/20 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 border-dashed rounded-full"></motion.div>
      ...
      className="absolute h-[544px] w-[544px]  md:h-[950px] md:w-[950px] rounded-full border opacity-20  border-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
        <div className="absolute h-2 w-2 top-1/2 left-0 bg-white rounded-full -translate-x-1/2 -translate-y-1/2 "></div>
